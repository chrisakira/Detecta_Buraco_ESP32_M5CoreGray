 ...
 */
int csvReadText(File_* file, char* str, size_t size, char delim) {
  char ch;
  int rtn;
  size_t n = 0;
  while (true) {
...
//------------------------------------------------------------------------------
int csvReadInt32(File_* file, int32_t* num, char delim) {
  char buf[20];
  char* ptr;
...
//------------------------------------------------------------------------------
int csvReadInt16(File_* file, int16_t* num, char delim) {
  int32_t tmp;
...
//------------------------------------------------------------------------------
int csvReadUint32(File_* file, uint32_t* num, char delim) {
  char buf[20];
  char* ptr;
  int rtn = csvReadText(file, buf, sizeof(buf), delim);
  if (rtn < 0) return rtn;
...
//------------------------------------------------------------------------------
int csvReadUint16(File_* file, uint16_t* num, char delim) {
  uint32_t tmp;
...
//------------------------------------------------------------------------------
int csvReadDouble(File_* file, double* num, char delim) {
  char buf[20];
  char* ptr;
  int rtn = csvReadText(file, buf, sizeof(buf), delim);
  if (rtn < 0) return rtn;
...
//------------------------------------------------------------------------------
int csvReadFloat(File_* file, float* num, char delim) {
  double tmp;
